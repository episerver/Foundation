<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.BusinessFoundation.BaseEntityType" ClassName="Mediachase.Commerce.Manager.Apps.Customer.Primitives.Reference_ViewEntity_Organization_ParentId" %>
