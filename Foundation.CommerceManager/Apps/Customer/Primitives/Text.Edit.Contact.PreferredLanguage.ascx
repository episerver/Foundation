<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Text.Edit.Contact.PreferredLanguage.ascx.cs" Inherits="Mediachase.Commerce.Manager.Apps.Customer.Primitives.Text_Edit_Contact_PreferredLanguage" %>
