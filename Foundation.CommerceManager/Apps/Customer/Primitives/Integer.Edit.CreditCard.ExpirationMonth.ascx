<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Integer.Edit.CreditCard.ExpirationMonth.ascx.cs"
    Inherits="Mediachase.Commerce.Manager.Apps.Customer.Primitives.Integer_Edit_CreditCard_ExpirationMonth" %>
        ...
        <td>
            <table cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator runat="server" id="ExpireMonthRequired" ControlToValidate="ddlValue"
