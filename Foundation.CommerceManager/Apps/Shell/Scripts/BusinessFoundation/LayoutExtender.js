...
Ibn.LayoutExtender.prototype =
{
	...
	initialize: function()
	{
		...
		if (this._containerId.parentNode.offsetHeight - this._containerId.offsetTop >= 0)
...
//		cur_y -= 16;
    ...
    resize: function(regionName) {
       ...
       if (this.getForm().clientHeight - this._containerId.offsetTop >= 0)
		this._containerId.style.height = this.getForm().clientHeight - this._containerId.offsetTop + "px"; /**/
	   else if (this.getForm().parentNode.offsetHeight >= 0)
	    this._containerId.style.height = this.getForm().parentNode.offsetHeight + "px";	    
