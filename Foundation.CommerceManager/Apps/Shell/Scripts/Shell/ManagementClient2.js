...
function MC_ChangeView(appId, viewId, params)
{
	...
	if (this.ContentFrame != null)
	{
		if (!isMetaClass)
		{
			if (params != undefined)
			{
				$get(this.ContentFrame).src = this.BASE_URL + 'ContentFrame.aspx?_a=' + appId + '&_v=' + viewId + '&' + params;
			}
			else
			{
			    $get(this.ContentFrame).src = this.BASE_URL + 'ContentFrame.aspx?_a=' + appId + '&_v=' + viewId;
			}
		}
		else
		{
			if (params != undefined)
			{
			    $get(this.ContentFrame).src = this.BASE_URL + 'ContentFrame.aspx?ClassName=' + appId + '&_v=' + viewId + '&' + params;
			}
			else
			{
			    $get(this.ContentFrame).src = this.BASE_URL + 'ContentFrame.aspx?ClassName=' + appId + '&_v=' + viewId;
			}
		}
	}
...
function MC_OpenWindow(appId, viewId, params, arguments, width, height)
{
	...
	if (params != undefined)
		window.showModalDialog(this.BASE_URL + 'ContentFrame.aspx?_a=' + appId + '&_v=' + viewId + '&' + params, arguments, 'dialogHeight:' + height + 'px;dialogWeight:' + width + 'px;');
	else
	    window.showModalDialog(this.BASE_URL + 'ContentFrame.aspx?_a=' + appId + '&_v=' + viewId, arguments, features);
}
