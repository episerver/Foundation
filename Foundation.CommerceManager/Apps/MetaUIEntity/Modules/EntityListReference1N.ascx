<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EntityListReference1N.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaUIEntity.Modules.EntityListReference1N" %>
