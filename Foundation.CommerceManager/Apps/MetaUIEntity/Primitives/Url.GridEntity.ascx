<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.Ibn.Web.UI.MetaUI.EntityPrimitives.Url_GridEntity" Inherits="Mediachase.BusinessFoundation.BaseEntityType" %>
