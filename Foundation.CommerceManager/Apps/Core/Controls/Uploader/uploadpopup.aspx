...
<body>
    ...
    <a class="fu-toolbar" href="javascript:StartUpload();"><img align="absmiddle" style="border:0;" width="16" alt="" src="images/upload.gif" />&nbsp;<asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, Upload %>"/></a>&nbsp;
    </div>
