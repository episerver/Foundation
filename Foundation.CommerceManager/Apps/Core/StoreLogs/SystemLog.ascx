<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Commerce.Manager.Core.StoreLogs.SystemLog" Codebehind="SystemLog.ascx.cs" %>
...
<core:EcfListViewControl id="MyListView1" DataSourceID="ApplicationLogDataSource1" runat="server" DataKey="LogId" AppId="Core" ViewId="SystemLog" ShowTopToolbar="true"></core:EcfListViewControl>
<core:ApplicationLogDataSource runat="server" ID="ApplicationLogDataSource1" DataMode="SystemLog">
