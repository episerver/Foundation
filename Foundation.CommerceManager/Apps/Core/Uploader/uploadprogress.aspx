...
<head>
    <title><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:CoreStrings, Uploader_File_Uploading_Progress %>"/></title>
        ...
        <form id="ProgressBar" method="post" runat="server">
            <mcf:FileUploadProgress ID="fuProgress" runat="server" ProgressBarBoundaryStyle-BorderColor="#8080FF"
                ...
                <InfoTemplate>
                    ...
                    &nbsp;<%$ Resources:SharedStrings, From_Lowercase %>&nbsp;<%# DataBinder.Eval(Container, "UploadBytesTotal")%><br /><br />
