<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MetaDataImportTab.ascx.cs" Inherits="Mediachase.Commerce.Manager.Core.MetaData.Admin.Tabs.MetaDataImportTab" %>
...
<script type="text/javascript">
    ...
    var uploadHandler = '<%= Page.ResolveUrl("~/Apps/Core/Uploader/DnDUploadHandler.ashx?dndUpload=true&datatype=metadata") %>';
...
<div class="wh100" style="padding-left: 10px; padding-right: 5px; padding-top: 10px; padding-bottom: 5px;">
    ...
    <asp:Table ID="tblUpload" runat="server" CssClass="FileUpload" Width="100%">
        ...
        <asp:TableRow>
            <asp:TableCell Width="100%">
                <mc:FileUploadControl ID="FileUpCtrl" runat="server" ModeType="IFrame" BlockHeight="100px" AllowedFileTypes="xml"></mc:FileUploadControl>
        ...
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    ...
                    <tr>
                        <td align="left">
                            <b><asp:Label ID="CSVFiles" runat="server" Text="<%$ Resources:CatalogStrings, Upload_Xml_Files %>" /></b>
                            <br />
    ...
    <asp:UpdatePanel ID="MainPanel" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Button runat="server" ID="btnImport" Text="<%$ Resources:CoreStrings, MetaData_Start_Import %>" Enabled="false" CausesValidation="false" Width="100px" Height="30px" />
        </ContentTemplate>
    </asp:UpdatePanel>
    <!-- END: Import Button -->
    <core:ProgressControl Title="<%$ Resources:CoreStrings, MetaData_Import_Title %>" ID="ProgressControl1" runat="server" />
</div>