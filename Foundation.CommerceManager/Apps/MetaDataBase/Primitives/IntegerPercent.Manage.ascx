<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IntegerPercent.Manage.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaDataBase.Primitives.IntegerPercent_Manage" %>
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet">
	<tr>
		...
		<td>
			<asp:TextBox Runat="server" ID="txtMinValue" Width="150px" MaxLength="11" Text="0"></asp:TextBox>
			...
			<asp:RangeValidator ID="rvMinValue" runat="server" ErrorMessage="*" ControlToValidate="txtMinValue" Display="Dynamic" Type="Integer" MinimumValue="-2147483647" MaximumValue="2147483647"></asp:RangeValidator>
		</td>
	</tr>
	<tr>
		<td class="ibn-label" width="120px">
		...
		<td>
			<asp:TextBox Runat="server" ID="txtMaxValue" Width="150px" MaxLength="11" Text="100"></asp:TextBox>
