<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Text.Manage.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaDataBase.Primitives.Text_Manage" %>
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet">
	<tr>
		...
		<td>
			<asp:TextBox Runat="server" ID="txtMaxLen" Width="100px" MaxLength="4" Text="100"></asp:TextBox>
