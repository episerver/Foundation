<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MultiReferenceTypeList" Codebehind="MultiReferenceTypeList.ascx.cs" %>
					...
					<asp:GridView runat="server" ID="grdMain" AutoGenerateColumns="false" Width="100%" 
						...
						<Columns>
							<asp:TemplateField HeaderText="<%$Resources : GlobalMetaInfo, Name%>" SortExpression="Name" >
								<ItemTemplate>
									<a href='MultiReferenceTypeView.aspx?type=<%# Eval("Name")%>'><%# Eval("Name")%></a>
								</ItemTemplate>
