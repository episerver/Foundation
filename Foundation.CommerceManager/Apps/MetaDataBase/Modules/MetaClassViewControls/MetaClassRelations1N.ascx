<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MetaClassRelations1N.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaDataBase.Modules.MetaClassViewControls.MetaClassRelations1N" %>
