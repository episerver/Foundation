<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MetaClassRelationsN1.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaDataBase.Modules.MetaClassViewControls.MetaClassRelationsN1" %>
...
<asp:GridView runat="server" ID="MainGrid" AutoGenerateColumns="false" Width="100%" 
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="<%$Resources : GlobalMetaInfo, PrimaryObject%>" SortExpression="PrimaryName">
			<ItemTemplate>
				<%# Eval("PrimaryName")%>
			</ItemTemplate>
			<ItemStyle CssClass="ibn-vb2" />
