...
namespace Foundation.Commerce.Customer.Services
{
    ...
    public class CreditCardService : ICreditCardService
    {
        ...
        public void MapToCreditCard(CreditCardModel creditCardModel, ref CreditCard creditCard)
        {
        ...
        public void MapToModel(CreditCard creditCard, ref CreditCardModel creditCardModel)
        {
            creditCardModel.CreditCardType = (CreditCard.eCreditCardType)creditCard.CardType;
