...
namespace Foundation.Commerce.Order.Services
{
    public interface IOrdersService
    {
        ...
        ReturnFormStatus CreateReturn(int orderGroupId, int shipmentId, int lineItemId, decimal returnQuantity,
            string reason);
        ...
        Dictionary<ILineItem, List<ValidationIssue>> ChangeLineItemQuantity(int orderGroupId, int shipmentId,
