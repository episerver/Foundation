...
{
    [ContentType(DisplayName = "Commerce Settings Page", 
        GUID = "2cc55a83-e4bd-46a6-8b87-d5b22524ca5f", 
        Description = "The page that store commerce site settings",
        AvailableInEditMode = false)]
    [AvailableContentTypes(Availability.Specific, 
        Include = new Type[] { typeof(CommerceSettingsPage) }, 
        ExcludeOn = new Type[] { typeof(FoundationPageData) })]
    [ImageUrl("~/assets/icons/cms/pages/CMS-icon-page-29.png")]
    public class CommerceSettingsPage : CmsSettingsPage
    {
        #region Header
