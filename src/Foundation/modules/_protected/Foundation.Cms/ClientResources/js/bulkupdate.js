class BulkUpdate {
    ...
    getDefaultProperties(id) {
        axios.get("/episerver/foundation.cms/bulkupdate/getproperties/" + id)
            .then(function (result) {
                $('.checkbox-content-properties').empty();
                $.each(result.data, function (index, entry) {
                    var checkbox = `<label class="cb-container">`
    ...
    getLanguages() {
        $('.loading-box').show();
        axios.get("/episerver/foundation.cms/bulkupdate/getlanguages")
            .then(function (result) {
                $.each(result.data, function (index, entry) {
                    if (entry.DisplayName != null) {
    ...
    applyFilters(e) {
        ...
        axios.get("/episerver/foundation.cms/bulkupdate/get?contentTypeId=" + contentTypeId + "&language=" + language + "&properties=" + properties.join() + "&keyword=" + keyword)
            .then(function (result) {
