    ...
    public static class DisplayExtensions
    {
        public static void AddDisplay(this IServiceCollection services)
        {
            services.Configure<DisplayOptions>(displayOption =>
            {
                ...
                displayOption.Add("threequarter", "/displayoptions/threequarter", "col-lg-9 col-md-6 col-sm-12 col-xs-12 displaymode-three-quarters", "", "epi-icon__layout--three-quarters");
                ...
                displayOption.Add("one-sixth", "/displayoptions/one-sixth", "col-lg-2 col-md-4 col-sm-12 col-xs-12 displaymode-one-sixth", "", "epi-icon__layout--one-sixth");
            });
