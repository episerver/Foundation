...
namespace Foundation.Infrastructure.OpenGraph.Extensions
{
    internal static class StringBuilderExtensions
    {
        ...
        public static void AppendMetaPropertyContent(this StringBuilder stringBuilder, string property, DateTime content)
        {
            ...
            {
                stringBuilder.Append(content.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
            }
            else
            {
                stringBuilder.Append(content.ToString("MM/dd/yyyy HH:mm:ss tt", CultureInfo.InvariantCulture));
            }
