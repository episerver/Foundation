...
{
    [ContentType(DisplayName = "Demo Settings Page", 
        GUID = "f4a0e3a5-0963-4f9e-83f5-0b4816ba3508", 
        Description = "The page that store demo site settings")]
    [AvailableContentTypes(Availability.Specific, 
        Include = new Type[] { typeof(DemoSettingsPage) }, 
        ExcludeOn = new Type[] { typeof(FoundationPageData) })]
    [ImageUrl("~/assets/icons/cms/pages/CMS-icon-page-29.png")]
    public class DemoSettingsPage : CommerceSettingsPage, IFacetConfiguration
    {
        #region Header
