...
namespace Foundation.Cms.Blocks
{
    ...
    {
        [Display(Name = "Button text", Order = 10,  GroupName = SystemTabNames.Content)]
        public virtual string ButtonText { get; set; }

        [Display(Name = "Button link", Order = 20, GroupName = SystemTabNames.Content)]
        public virtual Url ButtonLink { get; set; }

        [Display(Name = "Button style", Order = 30, GroupName = SystemTabNames.Content)]
