...
namespace Foundation.Cms.Blocks
{
    ...
    public class HeroBlock : FoundationBlockData
    {
        ...
        [CultureSpecific]
        [UIHint(UIHint.Video)]
        [Display(Name = "Background video", Order = 20)]
    ...
    {
        [Display(Name = "Padding top", Order = 1)]
        public virtual int PaddingTop { get; set; }

        [Display(Name = "Padding right", Order = 2)]
        public virtual int PaddingRight { get; set; }

        [Display(Name = "Padding bottom", Order = 3)]
        public virtual int PaddingBottom { get; set; }

        [Display(Name = "Padding left", Order = 4)]
        public virtual int PaddingLeft { get; set; }

        [Display(Name = "Show background color", Order = 10)]
        public virtual bool ShowBackgroundColor { get; set; }

        [Display(Name = "Background color", Order = 20)]
        ...
        [CultureSpecific]
        [Display(Name = "Callout content", Order = 40)]
        ...
        [Display(Name = "Callout text color", Description = "Sets text color of callout content", Order = 50)]
        ...
        [Display(Name = "Callout content alighment", Order = 50)]
