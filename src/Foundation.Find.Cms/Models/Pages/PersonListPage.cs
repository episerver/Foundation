...
namespace Foundation.Find.Cms.Models.Pages
{
    [ContentType(DisplayName = "Person List Page", 
        ...
        Description = "Person List Page helps users can find people within an organisation",
        GroupName = FindTabNames.Person)]
    [AvailableContentTypes(Availability.Specific, Include = new[] { typeof(PersonItemPage) })]
