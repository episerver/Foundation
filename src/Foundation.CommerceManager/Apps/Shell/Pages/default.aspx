<%@ Page Language="C#" AutoEventWireup="True" Inherits="Mediachase.Commerce.Manager.Apps.Shell.Pages._default" CodeBehind="default.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function pageLoad() {
        Sys.Application._state.right = validateUrl(Sys.Application._state.right);
