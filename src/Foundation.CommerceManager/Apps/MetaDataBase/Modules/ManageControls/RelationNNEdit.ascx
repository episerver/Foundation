				...
				<table cellpadding="5" cellspacing="0" border="0" class="ibn-propertysheet" style="table-layout:fixed;">
					<tr>
						<td class="ibn-label" style="width:170px;">
							<asp:Literal ID="Literal4" runat="server" Text="<%$Resources : GlobalMetaInfo, CurrentObject%>" />:
						</td>
					...
					<tr>
						<td class="ibn-label" style="width:170px;" valign="top">
							<asp:Literal ID="Literal9" runat="server" Text="<%$Resources : GlobalMetaInfo, RelationName%>" />:
						</td>
						<td>
					...
					<tr>
						<td class="ibn-label">
							<asp:Literal ID="Literal10" runat="server" Text="<%$Resources : GlobalMetaInfo, FriendlyName%>" />:
						</td>
						<td>
		...
		<td style="padding:5px; padding-top:0px;" class="episerveroverwriteimage">
			...
			<div class="ibn-stylebox-light" style="padding:10px; padding-top:5px;">
				<table cellpadding="5" cellspacing="0" border="0" class="ibn-propertysheet" style="table-layout:fixed;">
					<tr>
						<td class="ibn-label" style="width:170px;">
							<asp:Literal ID="Literal1" runat="server" Text="<%$Resources : GlobalMetaInfo, DisplayRegion%>" />:
						</td>
						<td style="width:410px;">
					...
					<tr runat="server" id="RelatedDisplayTextRow">
						<td class="ibn-label">
							<asp:Literal ID="Literal2" runat="server" Text="<%$Resources : GlobalMetaInfo, DisplayText%>" />:
						</td>
						<td>
					...
					<tr runat="server" id="RelatedDisplayOrderRow">
						<td class="ibn-label">
							<asp:Literal ID="Literal3" runat="server" Text="<%$Resources : GlobalMetaInfo, DisplayOrder%>" />:
						</td>
						<td>
