<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaUI.Modules.SelectControls.SelectMultiReference" Codebehind="SelectMultiReference.ascx.cs" %>
