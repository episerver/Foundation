<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Date.Filter.@.@.Between.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaUIEntity.Primitives.Date_Filter__Between" %>
...
<div runat="server" id="container" style="display: inline;" class="innerInline" changevisibility="1">
	...
	<mc:Picker runat="server" ID="ctrlPicker2" DateCssClass="text" TimeCssClass="text" DateWidth="85px" ShowImageButton="false" ShowTime="false" DateIsRequired="true" AutoPostBack="true"/>
