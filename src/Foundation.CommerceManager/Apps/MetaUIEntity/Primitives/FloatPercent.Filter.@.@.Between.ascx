<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FloatPercent.Filter.@.@.Between.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaUIEntity.Primitives.FloatPercent_Filter__Between" %>
