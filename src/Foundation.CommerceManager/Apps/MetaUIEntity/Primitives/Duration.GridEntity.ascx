<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.UI.Web.Apps.MetaUI.EntityPrimitives.Duration_GridEntity" Inherits="Mediachase.BusinessFoundation.BaseEntityType" %>
