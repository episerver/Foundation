<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Commerce.Manager.Catalog.Tabs.CatalogImportTab" CodeBehind="CatalogImportTab.ascx.cs" %>
...
<div class="wh100" style="padding-left: 10px; padding-right: 5px; padding-top: 10px; padding-bottom: 5px;">
        ...
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    ...
                    <tr>
                        <td align="left">
                            <b><asp:Label ID="CSVFiles" runat="server" Text="<%$ Resources:CatalogStrings, Upload_Zip_Files %>" /></b>
                            <br />
    ...
    <asp:UpdatePanel ID="MainPanel" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:CheckBox ID="cbOverwriteDuplicates" runat="server" Text="Overwrite duplicate entries and nodes" /><br />
            <br />
