<%@ Control Language="C#" AutoEventWireup="true" Inherits="Apps_Catalog_GridTemplates_NodeHyperlinkTemplateSearch" Codebehind="NodeHyperlinkTemplateSearch.ascx.cs" %>
