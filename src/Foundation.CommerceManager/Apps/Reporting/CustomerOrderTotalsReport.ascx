<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomerOrderTotalsReport.ascx.cs"
    Inherits="Mediachase.Commerce.Manager.Apps.Reporting.CustomerOrderTotalsReport" %>
